...
def check_for_update(version):
    newest = requests.get("https://raw.githubusercontent.com/gokiimax/Smaug/main/version.txt").content.decode('utf-8')
    if newest == version:
        ...
        webbrowser.open("https://github.com/gokiimax/Smaug")